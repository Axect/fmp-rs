...
with plt.style.context(["science", "nature"]):
    ...
    ma_co_vol_nonzero = ma_co_vol[ma_co_vol != 0]
    ma_co_vol_mean = np.mean(ma_co_vol_nonzero)
    ...
    ma_co_sr_nonzero = ma_co_sr[ma_co_sr != 0]
    ma_co_sr_mean = np.mean(ma_co_sr_nonzero)
